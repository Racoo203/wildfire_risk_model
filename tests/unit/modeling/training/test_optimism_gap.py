...
def test_gap_is_standard_minus_spatial_for_every_metric():
    standard = {"auc": 0.90, "f1_macro": 0.80, "pr_auc_macro": 0.70, "qwk": 0.60}
    spatial = {"auc": 0.75, "f1_macro": 0.65, "pr_auc_macro": 0.60, "qwk": 0.50}
    ...
    assert gap["qwk"] == pytest.approx(0.10)


def test_gap_is_zero_when_standard_equals_spatial():
    values = {"auc": 0.82, "f1_macro": 0.77, "pr_auc_macro": 0.71, "qwk": 0.65}
...
def test_gap_can_be_negative_when_spatial_scores_higher():
    ...
    standard = {"auc": 0.70, "f1_macro": 0.60, "pr_auc_macro": 0.55, "qwk": 0.45}
    spatial = {"auc": 0.80, "f1_macro": 0.60, "pr_auc_macro": 0.50, "qwk": 0.45}
    ...
    assert gap["qwk"] == pytest.approx(0.0)
...
def test_gap_raises_on_missing_metric_key():
    standard = {"auc": 0.9, "f1_macro": 0.8, "pr_auc_macro": 0.7}  # missing qwk
    spatial = {"auc": 0.6, "f1_macro": 0.5, "pr_auc_macro": 0.4, "qwk": 0.3}
